...
model = YOLO(r"C:\Users\HP\Downloads\best2.pt")
...
def gmail_authenticate():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file('C:/Users/Tamil Adhavan/Downloads/racksecure_gmail_api_cred.json', SCOPES)
...
def send_email(frame_filename):
    ...
    email_message = create_message_with_attachment(
        to="keshavaak08@gmail.com",  # Updated recipient email
